...
export function chatGptHelp(): string {
  return [
    ...
    "",
    "Modes:",
    "  --openai-tunnel         Private/local MCP through OpenAI Secure MCP Tunnel; no public URL or Auth0 required.",
    "  --quick                 Legacy public OAuth testing flow using Auth0 DCR and a temporary Cloudflare URL.",
    "  --secure                Stable public OAuth flow requiring --public-url and normally a predefined client.",
    "",
    "Options:",
