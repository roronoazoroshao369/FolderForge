...
import type { FolderForgeConfig, OAuthHttpAuthConfig } from './types.js';
 ...
 */
export function fullConfig(): Record<string, unknown> {
 ...
 */
export function ensureConfigFile(projectRoot: string): string | null {
