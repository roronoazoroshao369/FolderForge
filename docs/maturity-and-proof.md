...
| Durable structured verification | Beta / locally verified | Owner/project/client/task binding, explicit status matrix, cancellation, dead-executor recovery without replay, tamper/state-file denial, preflight and uncertain-outcome tests, Proof Pack and Mission Control propagation | Sandboxed verification execution, distributed runners, cross-platform independent reproduction, and production observation |
